...
PANTHEIOS_EXTERN_C char const       PANTHEIOS_FE_PROCESS_IDENTITY[] =  "test.scratch.be.N";
...
extern "C" pan_be_N_t       PAN_BE_N_BACKEND_LIST[] =
{
#if 1
    ...
    ,   PANTHEIOS_BE_N_TERMINATOR_ENTRY
        ...
        PANTHEIOS_BE_N_STDFORM_ENTRY(1, pantheios_be_WindowsSyslog, PANTHEIOS_BE_N_F_IGNORE_INIT_FAILURE)
    ,   PANTHEIOS_BE_N_STDFORM_ENTRY(1, pantheios_be_WindowsDebugger, PANTHEIOS_BE_N_F_INIT_ONLY_IF_PREVIOUS_FAILED)
    ,   PANTHEIOS_BE_N_TERMINATOR_ENTRY
