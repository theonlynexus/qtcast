# Microsoft Developer Studio Project File - Name="test.scratch.be.N.fail" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.scratch.be.N.fail - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.be.N.fail.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.be.N.fail.mak" CFG="test.scratch.be.N.fail - Win32 Debug"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.scratch.be.N.fail - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.N.fail - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.be.N.fail - Win32 Release pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.scratch.be.N.fail - Win32 Release"
...
# ADD CPP /nologo /W3 /GX /O2 /I "$(STLSOFT)/include" /I "$(PANTHEIOS_ROOT)/include" /D "WIN32" /D "NDEBUG" /D "STRICT" /D "_CONSOLE" /YX /FD /c
...
# ADD LINK32 ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /version:1.0 /subsystem:console /map /machine:I386 /out:"Release/Be_N_fail_test.debug.exe" /libpath:"$(PANTHEIOS_ROOT)/lib"
# SUBTRACT LINK32 /pdb:none

!ELSEIF  "$(CFG)" == "test.scratch.be.N.fail - Win32 Debug"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "$(STLSOFT)/include" /I "$(PANTHEIOS_ROOT)/include" /D "WIN32" /D "_DEBUG" /D "STRICT" /D "_CONSOLE" /FR /YX /FD /GZ /c
...
# ADD LINK32 ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /version:1.0 /subsystem:console /map /debug /machine:I386 /out:"Debug/Be_N_fail_test.debug.exe" /pdbtype:sept /libpath:"$(PANTHEIOS_ROOT)/lib"
# SUBTRACT LINK32 /pdb:none

!ELSEIF  "$(CFG)" == "test.scratch.be.N.fail - Win32 Release pseudoUNIX"
...
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /W3 /GX /O2 /I "$(STLSOFT)/include" /I "$(PANTHEIOS_ROOT)/include" /D "WIN32" /D "NDEBUG" /D "STRICT" /D "_CONSOLE" /YX /FD /c
# ADD CPP /nologo /W3 /GX /O2 /I "$(STLSOFT)/include" /I "$(PANTHEIOS_ROOT)/include" /I "$(UNIXEM)/include" /D "UNIX" /D "NDEBUG" /D "STRICT" /D "_CONSOLE" /D "_STLSOFT_FORCE_ANY_COMPILER" /YX /FD /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0xc09 /d "NDEBUG"
# ADD RSC /l 0xc09 /d "NDEBUG"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /version:1.0 /subsystem:console /map /machine:I386 /out:"Release/Be_N_fail_test.debug.exe" /libpath:"$(PANTHEIOS_ROOT)/lib"
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /version:1.0 /subsystem:console /map /machine:I386 /out:"ReleaseUnix/test.scratch.be.N.unix.exe" /libpath:"$(PANTHEIOS_ROOT)/lib" /libpath:"$(UNIXEM)/lib"
# SUBTRACT LINK32 /pdb:none
...
# Name "test.scratch.be.N.fail - Win32 Release"
# Name "test.scratch.be.N.fail - Win32 Debug"
# Name "test.scratch.be.N.fail - Win32 Release pseudoUNIX"
...
SOURCE=..\test.scratch.be.N.fail.cpp
# End Source File
# End Group
...
SOURCE="$(PANTHEIOS_ROOT)\include\pantheios\implicit_link\bec.fail.h"
# End Source File
# Begin Source File
