...
static void test_1_01()
{
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(s_severities); ++i)
    {
        ...
        pantheios::pantheios_logputs(severity, "abc");
...
static void test_1_02()
{
    ...
    pantheios::pantheios_logputs(pantheios::error(1), "abc");
...
static void test_1_03()
{
    ...
    pantheios::pantheios_logputs(pantheios::error(0x01234567), "abc");
...
static void test_1_04()
{
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(s_severities); ++i)
    {
        ...
        pantheios::pantheios_logputs(severity, "abc");
        pantheios::pantheios_logputs(severity, "def");
        pantheios::pantheios_logputs(severity, "abcdefghijklmnopqrstuvwxyz");
        pantheios::pantheios_logputs(severity, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
        ...
        if(!results.empty()) // Do test here, so will work with any back-end
        {
            ...
            XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL("abcdefghijklmnopqrstuvwxyz", results[2].statement);

            PANTHEIOS_SEV_LEVELS_EQUAL(severity, results[3].severity);
            XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", results[3].statement);
        }
    }}
}
