...
static void test_1_02()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL("1.1", results[0].statement);
    XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL("-1.1", results[1].statement);
//    XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL("0.0000001", results[2].statement);
//    XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL("-0.0000001", results[3].statement);
}
