...
const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "test.unit.util.strnlen";
...
static void test_length_passed_through()
{
    ...
    {
        XTESTS_TEST_INTEGER_EQUAL(i, pantheios::util::strnlen("", i));
    }}
}
...
static void test_length_via_strlen()
{
    ...
    { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(strings); ++i)
    {
        ...
        XTESTS_TEST_INTEGER_EQUAL(::strlen(string), pantheios::util::strnlen(string, ~size_t(0)));
    }}
}
...
static void test_length_calculated_forwards()
{
    ...
    const char  string[] = "abcdefghijklm\0nop\0qrs\0tuvwxyz"; // lengths: 13, 17, 21
