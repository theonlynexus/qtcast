...
PANTHEIOS_EXTERN_C const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "test.unit.be.COMErrorObject";
            ...
            else
            {
                { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(severities); ++i)
                {
                    { for(size_t j = 0; j != STLSOFT_NUM_ELEMENTS(strings); ++j)
                    {
                        ...
                        pantheios_be_COMErrorObject_logEntry(NULL, token, severity, strings[j], ::strlen(strings[j]));
                        ...
                        else
                        {
                            ...
                            XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL(strings[j], ed);
                        }
                    }}
                }}
                ...
                { for(size_t i = 0; i != STLSOFT_NUM_ELEMENTS(severities); ++i)
                {
                    { for(size_t j = 0; j != STLSOFT_NUM_ELEMENTS(strings); ++j)
                    {
                        ...
                        else
                        {
                            ...
                            XTESTS_TEST_MULTIBYTE_STRINGS_EQUAL("the first string", ed);
                        }
                    }}
                }}
