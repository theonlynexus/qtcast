/* /////////////////////////////////////////////////////////////////////////
 * File:        examples/cpp/example.cpp.blob/example.cpp.blob.cpp
 *
 ...
 * fe.N, fe.simple, etc. */
PANTHEIOS_EXTERN_C const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "example.cpp.blob";
...
int main()
{
  try
  {
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes)), "]");


    // Log the blob, splitting into groups of 1 (8-bits) without a separator; Output: "bytes: [000102030405060708090a0b0c0d0e0f10111213]"

    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes), 1, NULL), "]");
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes), 1, " "), "]");
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes), 2, " "), "]");
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes), 4, " "), "]");
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes), 8, " "), "]");
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes), 1, " ", 4, "\n  "), "]");
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::blob(bytes, sizeof(bytes), 4, NULL, 1, "-"), "]");
