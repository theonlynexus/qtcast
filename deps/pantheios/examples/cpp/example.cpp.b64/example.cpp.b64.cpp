/* /////////////////////////////////////////////////////////////////////////
 * File:        examples/cpp/example.cpp.b64/example.cpp.b64.cpp
 *
 ...
 * fe.N, fe.simple, etc. */
PANTHEIOS_EXTERN_C const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "example.cpp.b64";
...
int main()
{
  try
  {
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::b64(bytes, sizeof(bytes)), "]");
    ...
    pantheios::log_NOTICE("bytes: [", pantheios::b64(bytes, sizeof(bytes), ::b64::B64_F_LINE_LEN_USE_PARAM, 16), "]");
