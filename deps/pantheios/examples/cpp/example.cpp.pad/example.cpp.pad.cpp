/* /////////////////////////////////////////////////////////////////////////
 * File:        examples/cpp/example.cpp.pad/example.cpp.pad.cpp
 *
 ...
 * fe.N, fe.simple, etc. */
PANTHEIOS_EXTERN_C const char PANTHEIOS_FE_PROCESS_IDENTITY[] = "example.cpp.pad";
...
int main()
{
  try
  {
    ...
    pantheios::log_NOTICE("Name: ", PANTHEIOS_RPAD(name, 40), ".");
